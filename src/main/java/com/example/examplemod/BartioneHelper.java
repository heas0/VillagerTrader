...
public class BartioneHelper {
    ...
    public static void setGoal(BlockPos blockPos) {
        if (BaritoneAPI.getProvider().getBaritoneForPlayer(mc.player) == null) return;

        BlockPos pos = BlockPos.containing(blockPos.getX(), blockPos.getY(), blockPos.getZ());
        GoalNear goal = new GoalNear(pos, 3);
    ...
    public static List<BlockPos> findChestsNearPlayer(int radius) {
